...
Sexto projeto de Fundamentos fornecido pela instituição Trybe, onde criamos varias funções utilizando Hofs e com cobertura de testes.


## Aprendizados

Aprendi a como utilizar as Hofs: map, filter, sort, find, forEach e reduce.
...
```bash
  git clone git@github.com:GuilhermeFMP/Trybe-Zoo-Functions.git
